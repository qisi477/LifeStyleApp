...
class MainActivity : AppCompatActivity(), MenuFragment.DataParser, SettingFragment.SettingData, View.OnClickListener {
    ...
    override fun settingDataHandler(
        ...
        Log.d(TAG_XX, "Changed: height($height) weight($weight) goal($goal) active($activityLevel)")
        val localData = LocalData(this)
        val usr = localData.getUser() ?: fakeUser2
